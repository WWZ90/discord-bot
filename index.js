...
const DISPUTE_THREADS_CHANNEL_ID = "964000735073284127";
const VERIFIERS_ALERTS_CHANNEL_ID = "1485660555879383211";
const VOTING_DISCUSSION_CHANNEL_ID = "719352532354465833";
...
const MIN_AGE_FOR_FALLBACK_CHECK_MS = 45 * 60 * 1000;
...
const INACTIVITY_ALERT_CHANNEL_ID = process.env.INACTIVITY_ALERT_CHANNEL_ID;
...
async function runInitialDisputeScan() {
...
async function cleanupDisputeCache() {
...
async function processThread(
  ...
  try {
    ...
    if (result.success) {
      ...
      alertedChannels.delete(threadChannel.id);
